          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                work nonstop to provide the most accurate book selection as
                possible for our students! We are diligent about our book
                selection and our books are always going
        ...
        <div className="container">
          <div className="m-2">
            ...
            <div className="mt-2">
              <div className="col-image-right"></div>
              <div className="mt-2">
                <h1>Our collection is alway changing!</h1>
                <p className="lead">
                  Try to check in daily as our collection is always changing! We
                  work nonstop to provide the most accurate book selection as
                  possible for our students! We are diligent about our book
                  selection and our books are always
